    ...
    <div style={{ background: "var(--wa-surface-1)", border: "1px solid var(--wa-border)", borderRadius: 16, padding: 32 }}>
      {sent ? (
        <div style={{ textAlign: "center", padding: "32px 0" }}>
          ...
          <p style={{ color: "var(--fg-2)", margin: "0 0 24px" }}>Você terá notícias em até 1 dia útil.</p>
          <div style={{ borderTop: "1px solid var(--wa-border)", paddingTop: 24 }}>
            <p style={{ fontSize: 14, color: "var(--fg-3)", marginBottom: 12 }}>Prefere falar agora?</p>
            <a
              href={"https://wa.me/5511987337655?text=" + encodeURIComponent("Oi, acabei de preencher o formulário no site da Wisdom Agency e gostaria de conversar!")}
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: "inline-flex", alignItems: "center", gap: 8,
                padding: "10px 20px", borderRadius: 8, fontSize: 14, fontWeight: 500,
                color: "#fff", backgroundColor: "#25D366", textDecoration: "none",
              }}
            >
